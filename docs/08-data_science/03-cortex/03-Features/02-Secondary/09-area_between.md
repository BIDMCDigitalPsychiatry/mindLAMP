...
An algorithm for calculating the Area between two GPS trajectories. 
...
```markdown
cortex.secondary.area_between.area_between(LOOKBACK=86400000, id="U1234567890", start=0, end=cortex.now(), resolution=86400000)
```
Output:
```markdown
{
  ...
  'resolution': 86400000,
  'data': [
           {'timestamp': 1607245200000, 'area_between': .6130470131747797},
           {'timestamp': 1607331600000, 'area_between': None},
                 .
                 .
                 .
           {'timestamp': 1608454800000, 'area_between': 0.4502036706434}
          ]
}
```
