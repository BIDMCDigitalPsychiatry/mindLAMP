...
- `entropy: number`: (units: None) the call degree.
...
```markdown
{
  ...
  'resolution': 86400000,
  'data': [
           {'timestamp': 1607072400000, 'call_degree': 0},
           {'timestamp': 1607331600000, 'call_degree': 2},
                 .
                 .
                 .
           {'timestamp': 1609232400000, 'call_degree': 4}
          ]
}
```
